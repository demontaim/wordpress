...
function iqra_education_logo_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control('iqra_education_show_tagline',array(
 	...
 	$wp_customize->add_setting('iqra_education_site_tagline_font_size_settings',array(
		'default'	=> 14,
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('iqra_education_site_tagline_font_size_settings',array(
		'label'	=> __('Logo Tagline Font Size','iqra-education'),
		'section'	=> 'title_tagline',
		'setting'	=> 'iqra_education_site_tagline_font_size_settings',
		'type'	=> 'number',
		'input_attrs' => array(
			'step'             => 1,
			'min'              => 0,
