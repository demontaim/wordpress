...
function iqra_education_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_setting('iqra_education_shop_page_sidebar',array(
       'default' => true,
       'sanitize_callback'	=> 'iqra_education_sanitize_checkbox'
    ));
    $wp_customize->add_control('iqra_education_shop_page_sidebar',array(
       'type' => 'checkbox',
       'label' => __('Enable / Disable Shop Page Sidebar','iqra-education'),
       'section' => 'iqra_education_shop_page_options',
    ));

    $wp_customize->add_setting('iqra_education_single_product_sidebar',array(
        'default' => true,
        'sanitize_callback'	=> 'iqra_education_sanitize_checkbox'
	));
	$wp_customize->add_control('iqra_education_single_product_sidebar',array(
     	'type' => 'checkbox',
      	'label' => __('Enable / Disable Single Product Sidebar','iqra-education'),
      	'section' => 'iqra_education_shop_page_options',
	));
	...
	$wp_customize->add_setting('iqra_education_position_product_sale',array(
        'default' => 'Right',
        'sanitize_callback' => 'iqra_education_sanitize_choices'
	));
	$wp_customize->add_control('iqra_education_position_product_sale',array(
        'type' => 'radio',
        'label' => __('Product Sale Position','iqra-education'),
        'section' => 'iqra_education_shop_page_options',
        'choices' => array(
	...
	$wp_customize->add_setting( 'iqra_education_border_radius_product_sale_text',array(
		'default' => 50,
		'sanitize_callback'	=> 'iqra_education_sanitize_float',
	));
	$wp_customize->add_control('iqra_education_border_radius_product_sale_text', array(
        'label'  => __('Product Sale Border Radius','iqra-education'),
        'section'  => 'iqra_education_shop_page_options',
        'type'        => 'number',
        'input_attrs' => array(
        	'step'=> 1,
    ...
    $wp_customize->add_setting('iqra_education_top_bottom_product_sale_padding',array(
		'default'=> '',
		'sanitize_callback'	=> 'iqra_education_sanitize_float',
	));
	$wp_customize->add_control('iqra_education_top_bottom_product_sale_padding',array(
		'label'	=> __('Top / Bottom Product Sale Padding ','iqra-education'),
		'input_attrs' => array(
            'step'             => 1,
			'min'              => 0,
			'max'              => 50,
	...
	$wp_customize->add_setting('iqra_education_left_right_product_sale_padding',array(
		'default'=> '',
		'sanitize_callback'	=> 'iqra_education_sanitize_float',
	));
	$wp_customize->add_control('iqra_education_left_right_product_sale_padding',array(
		'label'	=> __('Left / Right Product Sale Padding','iqra-education'),
		'input_attrs' => array(
            'step'             => 1,
			'min'              => 0,
			'max'              => 50,
	...
	$wp_customize->add_setting('iqra_education_product_sale_text_size',array(
		'default'=> 14,
		'sanitize_callback'	=> 'iqra_education_sanitize_float'
	));
	$wp_customize->add_control('iqra_education_product_sale_text_size',array(
		'label'	=> __('Product Sale Text Size','iqra-education'),
		'input_attrs' => array(
            'step'             => 1,
			'min'              => 0,
			'max'              => 50,
	...
	$wp_customize->add_setting('iqra_education_shop_products_navigation',array(
       'default' => 'Yes',
       'sanitize_callback'	=> 'iqra_education_sanitize_choices'
    ));
    $wp_customize->add_control('iqra_education_shop_products_navigation',array(
       'type' => 'radio',
       'label' => __('Woocommerce Products Navigation','iqra-education'),
       'choices' => array(
            'Yes' => __('Yes','iqra-education'),
            'No' => __('No','iqra-education'),
        ),
       'section' => 'iqra_education_shop_page_options',
    ));
    ...
    $wp_customize->add_setting( 'iqra_education_fixed_header_padding_option', array(
		'default'=> '',
		'sanitize_callback'	=> 'iqra_education_sanitize_float',
	) );
	$wp_customize->add_control( 'iqra_education_fixed_header_padding_option', array(
		'label'       => esc_html__( 'Fixed Header Padding','iqra-education' ),
		'section'     => 'iqra_education_width_layout',
		'type'        => 'number',
		'input_attrs' => array(
			'step'             => 1,
	...
	$wp_customize->add_setting('iqra_education_padding_top_bottom_slider_content',array(
		'default'=> '',
		'sanitize_callback'	=> 'iqra_education_sanitize_float',
	));
	$wp_customize->add_control('iqra_education_padding_top_bottom_slider_content',array(
		'label'	=> __('Top Bottom Slider Content Padding','iqra-education'),
		'section'=> 'iqra_education_slider',
		'input_attrs' => array(
            'step'             => 1,
			'min'              => 0,
	...
	$wp_customize->add_setting('iqra_education_padding_left_right_slider_content',array(
		'default'=> '',
		'sanitize_callback'	=> 'iqra_education_sanitize_float',
	));
	$wp_customize->add_control('iqra_education_padding_left_right_slider_content',array(
		'label'	=> __('Left Right Slider Content Padding','iqra-education'),
		'section'=> 'iqra_education_slider',
		'input_attrs' => array(
            'step'             => 1,
			'min'              => 0,
	...
	$wp_customize->add_setting('iqra_education_post_break_block_setting',array(
        'default' => 'Into Blocks',
        'sanitize_callback' => 'iqra_education_sanitize_choices'
	));
	$wp_customize->add_control('iqra_education_post_break_block_setting',array(
        'type' => 'radio',
        'label' => __('Display Blog Page posts','iqra-education'),
        'section' => 'iqra_education_blog_post',
        'choices' => array(
            'Into Blocks' => __('Into Blocks','iqra-education'),
            'Without Blocks' => __('Without Blocks','iqra-education'),
        ),
	) );
